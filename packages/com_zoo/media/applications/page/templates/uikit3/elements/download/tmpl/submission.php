...
<div id="<?php echo $this->identifier; ?>">
	...
	<div class="download-select">
		...
		<div class="zo-upload">
			<input type="text" class="uk-input" id="filename<?php echo $this->identifier; ?>" readonly="readonly" />
            <div class="zo-button-container">
    			<button class="uk-button uk-button-default search" type="button"><?php echo JText::_('Search'); ?></button>
    ...
    <div class="uk-margin download-preview">
        ...
        <span class="download-cancel" title="<?php JText::_('Remove file'); ?>"><span class="uk-icon" uk-icon="icon: trash"></span></span>
    </div>

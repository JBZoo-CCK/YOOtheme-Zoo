...
<?php if ($this->errors): ?>
	...
	<div class="uk-alert-danger uk-alert"><?php echo $msg; ?></div>
<?php endif; ?>

<form id="item-submission" class="uk-form-horizontal" action="<?php echo JRoute::_($this->app->route->submission($this->submission, $this->type->id, null, $this->item->id, $this->redirectTo)); ?>" method="post" name="submissionForm" accept-charset="utf-8" enctype="multipart/form-data">
	...
	<div class="uk-margin">
		<button type="submit" id="submit-button" class="uk-button uk-button-primary"><?php echo $this->item->id ? JText::_('Save') : JText::_('Submit Item'); ?></button>

	...
	<?php elseif ($active_author->isGuest()) : ?>
		...
		<?php if (!$registered) : ?>
			...
			<div class="uk-margin <?php if($req) echo 'required' ;?>">
				<input id="comments-author" class="uk-input uk-form-width-large" type="text" name="author" placeholder="<?php echo JText::_('Name'); ?> <?php if ($req) echo "*"; ?>" value="<?php echo $active_author->name; ?>"/>
			</div>

			<div class="uk-margin <?php if($req) echo 'required' ;?>">
				<input id="comments-email" class="uk-input uk-form-width-large" type="text" name="email" placeholder="<?php echo JText::_('E-mail'); ?> <?php if ($req) echo "*"; ?>" value="<?php echo $active_author->email; ?>"/>
			</div>

			<div class="uk-margin">
				<input id="comments-url" class="uk-input uk-form-width-large" type="text" name="url" placeholder="<?php echo JText::_('Website'); ?>" value="<?php echo $active_author->url; ?>"/>
			</div>

...
<script type="text/javascript">
	jQuery(function($) {
		$('#adminForm').ApplicationEdit({url: 'index.php?option=com_zoo&controller=new', application_id: '<?php echo $this->application->id; ?>', application_group: '<?php echo $this->application->getGroup();?>'});
